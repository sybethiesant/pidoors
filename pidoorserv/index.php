                            ...
                            <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap gap-1">
                                ...
                                <div class="d-flex align-items-center gap-1 flex-wrap">
                                    ...
                                    <?php if ($status === 'online' && is_admin() && empty($door['unlock_requested'])): ?>
                                        <?php if (!empty($door['held_open'])): ?>
                                            <button type="button" class="btn btn-sm btn-outline-danger py-0 px-2 btn-hold" data-door="<?php echo htmlspecialchars($door['name']); ?>" data-action="release">Unhold</button>
                                        <?php else: ?>
                                            <button type="button" class="btn btn-sm btn-outline-warning py-0 px-2 btn-unlock" data-door="<?php echo htmlspecialchars($door['name']); ?>">Unlock</button>
                                            <button type="button" class="btn btn-sm btn-outline-secondary py-0 px-2 btn-hold" data-door="<?php echo htmlspecialchars($door['name']); ?>" data-action="hold">Hold</button>
                                        <?php endif; ?>
                                    <?php endif; ?>
                                </div>
                            </li>
